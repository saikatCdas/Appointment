<template>
  <main>
    ...
    <div class="container mx-auto px-6 py-16 text-center">
        ...
        <h1 class="text-3xl font-bold text-white lg:text-4xl">Build Your Future</h1>
        <p class="mt-6 text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Libero similique obcaecati illum mollitia.</p>
        </div>
    ...
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-white lg:text-4xl">Departments</h1>

        <p class="mt-4 text-center text-gray-300">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus</p>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-white">Lorem Ipsum</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-400">Computer Science Engineering</p>
        </div>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-white">Lorem Ipsum</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-400">Electrical and Electronics Engineering</p>
        </div>
        ...
        <div>
            ...
            <h2 class="mt-4 text-2xl font-semibold capitalize text-white">Lorem Ipsum</h2>
            <p class="mt-2 text-lg uppercase tracking-wider text-blue-400">Civil Engineering</p>
        </div>
        </div>
    </div>
    </section>
    ...
    <section class="bg-gray-900">
    <div class="h-[32rem] bg-gray-800">
        <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-white lg:text-4xl">Our Faculty Team</h1>
        ...
        <p class="mx-auto mt-6 max-w-2xl text-center text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo incidunt ex placeat modi magni quia error alias, adipisci rem similique, at omnis eligendi optio eos harum.</p>
        </div>
    </div>
    ...
    <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 border-gray-700 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-white">arthur melo</h1>

            <p class="mt-2 capitalize text-gray-300">Lorem Ipsum</p>
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 border-gray-700 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-white">Pamela Anderson</h1>
        ...
        <div class="flex flex-col items-center rounded-xl border p-4 border-gray-700 sm:p-6">
            ...
            <h1 class="mt-4 text-2xl font-semibold capitalize text-white">John Doe</h1>
    ...
    <section class="bg-gray-900">
    <div class="container mx-auto px-6 py-10">
        <h1 class="text-center text-3xl font-semibold capitalize text-white lg:text-4xl">What Students saying</h1>
        ...
        <button class="hidden rounded-full border p-2 transition-colors duration-300 rtl:-scale-x-100 border-gray-700 text-gray-200 hover:bg-gray-800 lg:block">
        ...
        <div>
            ...
            <div class="mt-4 text-center">
                <h1 class="font-semibold text-white">Mia Brown</h1>
                <span class="text-sm text-gray-200">student</span>
            </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <h1 class="text-3xl font-semibold capitalize text-white lg:text-4xl">From the blog</h1>

        <p class="mx-auto mt-4 max-w-lg text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
        </div>
        ...
        <div>
            ...
            <div class="absolute bottom-0 flex p-3 bg-gray-900">
                ...
                <p class="text-sm text-gray-400">Lorem Ipsum</p>
                </div>
            </div>
            </div>

            <h1 class="mt-6 text-xl font-semibold text-white">What do you want to know about UI</h1>

            <hr class="my-6 w-32 text-blue-500" />

            <p class="text-sm text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis fugit dolorum amet dolores praesentium, alias nam? Tempore</p>

            <a href="blog/1" class="mt-4 inline-block text-blue-500 underline hover:text-blue-400">Read more</a>
        </div>
        ...
        <div>
            ...
            <h1 class="mt-6 text-xl font-semibold text-white">All the features you want to know</h1>
        ...
        <div>
            ...
            <h1 class="mt-6 text-xl font-semibold text-white">Which services you get from Meraki UI</h1>
    ...
    <div class="container mx-auto max-w-4xl px-6 py-10">
        <h1 class="text-center text-4xl font-semibold text-white">Frequently asked questions</h1>

        <div class="mt-12 space-y-8">
        <div class="rounded-lg border-2 border-gray-700">
            <button class="flex w-full items-center justify-between p-8">
            <h1 class="font-semibold text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry?</h1>
            ...
            <p class="p-8 text-sm text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas eaque nobis, fugit odit omnis fugiat deleniti animi ab maxime cum laboriosam recusandae facere dolorum veniam quia pariatur obcaecati illo ducimus?</p>
        </div>
    ...
    <section class="min-h-screen bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900">
    <div class="container mx-auto flex min-h-screen flex-col px-6 py-12">
        ...
        <div class="text-white lg:mx-6 lg:w-1/2">
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white">Sylhet , Bangladesh </span>
            </p>
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white">+8800000 </span>
            </p>
            ...
            <p class="-mx-2 flex items-start">
                ...
                <span class="mx-2 w-72 truncate text-white">acb@gamil.com</span>
            </p>
            </div>
        ...
        <div class="mt-8 lg:mx-6 lg:w-1/2">
            <div class="mx-auto w-full overflow-hidden rounded-xl px-8 py-10 shadow-2xl bg-gray-900 lg:max-w-xl">
            <h1 class="text-2xl font-medium text-gray-200">Contact form</h1>

            <form class="mt-6">
                <div class="flex-1">
                <label class="mb-2 block text-sm text-gray-200">Full Name</label>
                <input type="text" placeholder="John Doe" class="mt-2 block w-full rounded-md border px-5 py-3 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 border-gray-600 bg-gray-900 text-gray-300 focus:border-blue-300" />
                </div>

                <div class="mt-6 flex-1">
                <label class="mb-2 block text-sm text-gray-200">Email address</label>
                <input type="email" placeholder="johndoe@example.com" class="mt-2 block w-full rounded-md border   px-5 py-3 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 border-gray-600 bg-gray-900 text-gray-300 focus:border-blue-300" />
                </div>

                <div class="mt-6 w-full">
                <label class="mb-2 block text-sm text-gray-200">Message</label>
                  <textarea class="mt-2 block h-32 w-full rounded-md border px-5 py-3 placeholder-gray-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 border-gray-600 bg-gray-900 text-gray-300 focus:border-blue-300 md:h-48" placeholder="Message"></textarea>
                </div>
